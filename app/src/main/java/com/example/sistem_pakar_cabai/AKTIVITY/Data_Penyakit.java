...
import com.example.sistem_pakar_cabai.ADAPTER.Adapter;
...
import static com.example.sistem_pakar_cabai.ENTITY.Index.TAG_LEVEL;
...
public class Data_Penyakit extends AppCompatActivity {
    ...
    public static String level_status;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myrv = (RecyclerView)findViewById(R.id.rv_data_penyakit);
        mManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        myrv.setLayoutManager(mManager);
        mAdapter = new Adapter(this, lst_data_penyakit);
        ...
        myFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Data_Penyakit.this, Data_Penyakit_Insert.class));
            }
        });
